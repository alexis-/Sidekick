...
namespace Sidekick.FilterBuilder.Expressions
{
  ...
  public class TimeSpanExpression : NullableDataTypeExpression
  {
    ...
    public TimeSpanExpression(bool isNullable)
    {
      ...
      SpanTypes =
        Enum.GetValues(typeof(TimeSpanType)).Cast<TimeSpanType>().ToList();
    ...
    protected override void OnPropertyChanged(
      AdvancedPropertyChangedEventArgs e)
    {
      base.OnPropertyChanged(e);

      if (e.HasPropertyChanged(() => SelectedSpanType) ||
          e.HasPropertyChanged(() => Amount))
      {
